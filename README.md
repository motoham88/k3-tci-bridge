...
<table>
<tr>
<td><img src="screenshots/web-ui-top.png" alt="Web UI, top: S-meter, frequency with A>B, hold-to-listen REV, typed entry, tuning strip and band buttons, mode, filter presets, width and SHIFT sliders, AGC, lock, preamp, attenuator, NB, NR, notch, crystal filter, RX antenna, ANT1/ANT2, squelch and RIT/XIT" width="320"></td>
